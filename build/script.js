...
async function loadFacts() {
  const res = await fetch(
    "https://jsstuhiulqttybxtkhxq.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impzc3R1aGl1bHF0dHlieHRraHhxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzM4MDk4MzQsImV4cCI6MjA0OTM4NTgzNH0.BfpaD9eKi56HGwrWQzGuzNmaLYUY6oLl55EViKn-56U",
      },
    }
  );
